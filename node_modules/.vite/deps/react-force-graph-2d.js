...
function I(n2, l2, u2, t3, i2, r2, o2, e2, f2, c3, s2) {
  var a3, h2, y3, w2, d2, g2, _2 = t3 && t3.__k || v, m3 = l2.length;
  for (f2 = P(u2, l2, _2, f2, m3), a3 = 0; a3 < m3; a3++) null != (y3 = u2.__k[a3]) && (h2 = -1 == y3.__i ? p : _2[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h2, i2, r2, o2, e2, f2, c3, s2), w2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && q(h2.ref, null, y3), s2.push(y3.ref, y3.__c || w2, y3)), null == d2 && null != w2 && (d2 = w2), 4 & y3.__u || h2.__k === y3.__k ? f2 = A(y3, f2, n2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : w2 && (f2 = w2.nextSibling), y3.__u &= -7);
  return u2.__e = d2, f2;
}
...
function O(n2, u2, t3, i2, r2, o2, e2, f2, c3, s2) {
  ...
  n: if ("function" == typeof j2) try {
    if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C2 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C2 ? C2.props.value : a3.__ : i2, t3.__c ? m3 = (h2 = u2.__c = t3.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = D), C2 && C2.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2) S2 && null == j2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), S2 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = d(d({}, i2), h2.getChildContext())), S2 && !p2 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(v2, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = N(a3.props.children)), f2 = I(n2, w(L2) ? L2 : [L2], u2, t3, i2, r2, o2, e2, f2, c3, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e2.push(h2), m3 && (h2.__E = h2.__ = null);
  } catch (n3) {
...
var utils = {
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      const a4 = aligned[0].y, b10 = aligned[1].y, c4 = aligned[2].y, d3 = a4 - 2 * b10 + c4;
      if (d3 !== 0) {
        const m1 = -sqrt(b10 * b10 - a4 * c4), m22 = -a4 + b10, v12 = -(m1 + m22) / d3, v2 = -(-m1 + m22) / d3;
        return [v12, v2].filter(reduce2);
      } else if (b10 !== c4 && d3 === 0) {
        return [(2 * b10 - c4) / (2 * b10 - 2 * c4)].filter(reduce2);
      }
      return [];
    }
